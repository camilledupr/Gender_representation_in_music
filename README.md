...
Certain acoustic dimensions (e.g., timbre coefficients or loudness) contribute more strongly than others to gender differentiation.

### **H3 — Genre Interaction**  
The relationship between artist gender and acoustic features depends on genre.  
Differences may be more pronounced in certain musical contexts (e.g., pop, rap) than in others.
...
## **A Limitedly Explored Question: Acoustic Differences**

While representation and industry inequalities are well documented, the question of whether music itself—its **acoustic structure**—differs across gender lines remains underexplored.

### **Contribution: An Acoustic-Centred Approach**
This project uses a curated subset of the MSD to examine possible gender-related acoustic patterns, while controlling for musical genre.
